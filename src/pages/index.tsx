  ...
  return (
    ...
    <div className="h-[2125px] relative bg-[#F1F4FD]">
      <div className="h-[713px] relative">
        ...
        <div
          ref={firstRef}
          className={`mx-auto max-w-md transition-all duration-400 transform absolute bottom-[-264px] xl:bottom-[-338px] left-1/2 -translate-x-1/2
            ${ firstInView ? "opacity-100 scale-100" : "opacity-0 scale-75" }`}
        >
          <div className="w-[336px] h-[398px] xl:w-[498px] xl:h-[590px]">
            <Image 
              src={test3}
              alt="애니메이션 이미지" width={498} height={590} layout="responsive" className="w-full" />
          </div>
        </div>
      </div>
