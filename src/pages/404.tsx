    ...
    <>
      ...
      <div className="px-[10px] py-[80px] flex flex-col items-center">
        ...
        <div className="mt-[24px]">
          <Link
            href="/"
            className="px-4 py-2 bg-[#4CBFA4] font-pre text-white font-[48px] font-[500] rounded-lg shadow-lg hover:bg-[#3AA98E] transition-colors"
          >
            홈으로 이동
          </Link>
        </div>
