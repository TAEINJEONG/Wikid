...
const WikiPage = () => {
  ...
  const fetchData = useCallback(async () => {
    // if (id ) {
      try {
        // 엑세스 토큰을 가져온다고 가정
        const accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidGVhbUlkIjoiZGVmYXVsdCIsInNjb3BlIjoiYWNjZXNzIiwiaWF0IjoxNzQyOTcxNDY5LCJleHAiOjE3NDI5NzMyNjksImlzcyI6InNwLXdpa2llZCJ9._5IBiiLcdOu7Jjp6JROffLokRTChFh6G9fdhgIx8yvY"// 실제로는 로그인 후 받아온 accessToken을 사용해야 합니다.
